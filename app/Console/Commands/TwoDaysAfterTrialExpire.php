...
class TwoDaysAfterTrialExpire extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'command:twodaysaftertrialexpire';
     ...
     * @var string
     */
    protected $description = 'This command sends email to users two days after trial expires';
        ...
        if ($all_users != null) {
            foreach ($all_users as $user_key => $user) {
                ...
                try {
                    ...
                    $subject        = 'Its Been A While Upgrade Your Account Now!';
