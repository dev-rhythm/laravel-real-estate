                        ...
                        <div class="col-md-10 col-md-offset-1">
                            ...
                            <fieldset class="content-group">
                                <legend class="text-bold">
                                    <h3>Virtual Tour Gallery</h3> <a href="" class="btn btn-info" data-toggle="modal"
                                        data-target="#modal_virtual_tour">+ Add Virtual Tour</a>
                                </legend>
                            </fieldset>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h5 class="modal-title">3D Tour</h5>
                </div>

                <form action="{{route('save-virtual')}}" method="POST" id="vr_tour_form" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    ...
                    <div class="modal-body">
                        ...
                        <div>
                            ...
                            <div class="form-group">
                                <label class="display-block text-semibold">Tour Type</label>
                                <div class="err_display"></div>
                                <label class="radio-inline">
                                    <input type="radio" value="virtual" name="type" class="styled type">
                                    Virutal Tour
                                </label>
                            ...
                            <div class="form-group desc virtual" style="display:none" id="edit-field-vt-link">
                                <div
                                    ...
                                    <label for="edit-field-vt-link-und-0-value"
                                        class="control-label text-semibold">Virtual Tour
                                        URL </label>
                                    <div class="err_display"></div>
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="submit" id="add-tour" class="btn btn-primary">Add Tour</button>
                        </div>
                </form>
            </div>
        </div>
