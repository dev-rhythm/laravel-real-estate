                ...
                <div class="content">
                    ...
                    <div class="panel panel-flat">
                        <div class="panel-heading">
                            <h5 class="panel-title">Edit Coupon</h5>
                        ...
                        <div class="panel-body">
                            ...
                            <form class="form-horizontal" action="{{action('CouponController@update', $coupon->id)}}"
                                method="POST">
                                <fieldset class="content-group">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-lg-2">Discount Amount <span
                                                class="text-danger">*</span></label>
                                        <div class="col-lg-10">
                                            <input type="number" name="coupon_amount" value="{{$coupon->coupon_amount}}"
                                                class="form-control">
