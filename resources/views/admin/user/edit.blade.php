							...
							<form class="form-horizontal" action="{{route('admin.user.update')}}" method="POST" >
                                ...
                                <input type="hidden" name="id" value="{{$user->id}}">
									...
									<div class="form-group">
										...
										<div class="col-lg-10">
											<input type="text" name="email" value="{{$user->email}}"  disabled readonly class="form-control" placeholder="Enter Email">
										</div>
									</div>
			                        ...
			                        <div class="form-group">
			                        	...
			                        	<div class="col-lg-10">
				                            <select  name="user_role" value="{{$user->fname}}" class="form-control">
